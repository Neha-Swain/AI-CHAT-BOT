    ...
    <div className='chat-app'>
        ...
        <div className="chat-window">
           <div className="chat-title">
            ...
            <i className="bx bx-arrow-back arrow" onClick={onGoBack}></i></div> 
            <div className="chat">
            ...
            {/* onSubmit prevents the form from reloading the entire page */}
            ...
            <input type="text" className="msg-input" placeholder='Type a message' value={inputValue} 
            onChange={handleInputChange} onKeyDown={handleKeyDown} onFocus={()=>setShowEmojiPicker(false)}/>
            <i className="fa-solid fa-paper-plane" onClick={sendMessage}></i></form>
        </div>
    </div>
  )
}
